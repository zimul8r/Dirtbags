...
It turned out to be quite difficult to automatically return dice that rolles sucesses to the ACTION POOL. We may solve that one day, but for now, you can use the SUCCESSES/CRIT button to recover dice from the RESERVE into your ACTION POOL. (DM) Simply click the SUCCESSES/CRIT button once for each success you had in the action roll and those dice will move out of the RESERVE. You can also click it once if you scored a crit to claim your extra RESERVE die. If threre are no dice in RESERVE, clicking this button does nothing.
...
The RESIST Button
The RESIST button works exactly like the ACTION and FIRE buttons, except that it makes a dice roll using all of the dice in the ACTION ROLL POOLand all three AMMUNITION ROLL POOLs. It is up to you to load up these pools with the appropriate number of dice for your weapons' firing modes.
...
Other Stats
All of the other stats fields, M.I.L.K., Carrying Capacity, Confirmed Kills, Credits, and Bones, Cunning, Nerves, and body stats, arer there to record and track your stats.
